...
public static class Diagnostics
{
    ...
    private static readonly DiagnosticDescriptor _ECHDI02 =
        new DiagnosticDescriptor("ENHDI02", "Root namespace resolve error", "Unable to resolve root namespace",
            "EnhDiModuleGenerator", defaultSeverity: DiagnosticSeverity.Error, isEnabledByDefault: true);
    ...
    private static readonly DiagnosticDescriptor _ECHDI04 =
        new DiagnosticDescriptor("ENHDI04", "Incompatible attributes", "The attributes of this class cannot be used together",
            "EnhDiModuleGenerator", defaultSeverity: DiagnosticSeverity.Error, isEnabledByDefault: true);
    ...
    public static Diagnostic ECHDI02(DiagnosticSeverity severity) =>
        Diagnostic.Create(_ECHDI02, Location.None, severity);

    public static Diagnostic ECHDI03(Location location, DiagnosticSeverity severity) =>
        Diagnostic.Create(_ECHDI03, location, severity);
    
    public static Diagnostic ECHDI04(Location location, DiagnosticSeverity severity) =>
