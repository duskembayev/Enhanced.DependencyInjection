...
{{
    ...
    {{
        ...
        /// </summary>
        public static partial IServiceCollection {MethodName}(this IServiceCollection serviceCollection, IConfiguration? configuration = null);
    }}
}}";
...
{{
    internal static partial class EnhancedDependencyInjectionExtensions
    {{
        public static partial IServiceCollection {MethodName}(this IServiceCollection serviceCollection, IConfiguration? configuration)
        {{
            serviceCollection.Module<global::{moduleNamespace}.{ModuleName}>(configuration);
...
using ServiceLifetime = global::Microsoft.Extensions.DependencyInjection.ServiceLifetime;");
        ...
        using (indentedWriter.BeginScope("namespace {0}", ctx.ModuleNamespace))
        {
            ...
            using (indentedWriter.BeginScope("public void AddEntries(IServiceCollection serviceCollection, IConfiguration? configuration)"))
            {
